...
// export default TermsCondition = ({ user }) => {
            ...
            <div className="container">
                <div className="row">
                    <div className=" col-sm-12">
                        <h3>INTRODUCTION</h3>
                        <p>
                        Welcome to the jumia.com.ng website (the "Site"). These terms & conditions ("Terms and Conditions") apply to the Site, and all of its divisions, subsidiaries, and affiliate operated Internet sites which reference these Terms and Conditions.
This website is owned and operated by Ecart Internet Services Nigeria Limited.  For the purposes of this website, “seller”, “we”, “us” and “our” all refer Jumia.com.ng.
                        </p>
                        <p>
...
By completing an order or signing up, you agree to receive a) emails associated with finalizing your order, which may contain relevant offers from third parties, and b) emails asking you to review Jumia and your purchase and c) promotional emails, SMS and push notifications from Jumia. You may unsubscribe from promotional emails via a link provided in each email. If you would like us to remove your personal information from our database, unsubscribe from emails and/or SMS, please email Customer Service email address by country
                    ...
                    <div className="col-sm-12">
                        <h3>INFORMATION AVAILABLE ON WEBSITE</h3>
                        <p>
...
Jumia store the address and might use it for commercial purposes
